export function SectionHeading({
  ...
  const headingClass = isCentered
    ? "mx-auto max-w-5xl text-balance font-[family:var(--font-inter)] text-[clamp(2.2rem,3.5vw,3.4rem)] font-normal leading-tight tracking-tight text-[var(--color-app-text)]"
