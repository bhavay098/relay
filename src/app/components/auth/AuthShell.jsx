      ...
      <section className="relative isolate overflow-hidden px-4 pb-10 pt-6 sm:px-6 lg:px-8 lg:pb-12 lg:pt-10">
        ...
        <div className="mx-auto grid w-full max-w-[1120px] gap-8 lg:grid-cols-[1fr_0.72fr] lg:items-center">
          <div className="space-y-6 py-4 lg:py-10">
            ...
            <h1 className="max-w-3xl text-balance font-[family:var(--font-inter)] text-[clamp(3rem,5vw,4.75rem)] font-semibold leading-tight tracking-[-0.065em] text-[var(--color-app-text)]">
              {title}
            </h1>
