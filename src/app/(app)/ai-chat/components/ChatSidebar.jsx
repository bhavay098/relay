...
export function ChatSidebar({
  ...
  return (
    <>
      {/*
        On mobile there's no room for an inline sidebar, so it becomes a
      ...
      */}
      <button
        ...
        onClick={onCollapse}
      />
      <aside className="home-panel fixed inset-y-4 left-4 right-4 z-[71] flex flex-col overflow-hidden rounded-[28px] sm:static sm:inset-auto sm:z-auto sm:w-72 sm:shrink-0">
